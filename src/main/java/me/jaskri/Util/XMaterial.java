...
public enum XMaterial {
    ...
    private static final CacheBuilder<String, XMaterial> NAME_CACHE = CacheBuilder.newBuilder().expireAfterAccess(1L, TimeUnit.HOURS).build();
    ...
    public static XMaterial matchXMaterial(@Nonnull ItemStack item) {
        ...
        if (!XMaterial.Data.ISFLAT && item.hasItemMeta() && material.equals("MONSTER_EGG")) {
        ...
        } else if (XMaterial.Data.ISFLAT && !supports(14) && material.equals("CACTUS_GREEN")) {
            return GREEN_DYE;
        } else {
